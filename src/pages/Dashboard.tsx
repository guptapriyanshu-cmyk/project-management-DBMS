...
const Dashboard = () => {
  ...
  const stats = [
    ...
    { label: 'Active Customers', value: '8,439', icon: <Users size={24} />, color: 'bg-purple-500', trend: '+8.1%' },
    { label: 'Weekly Sales', value: '432', icon: <Activity size={24} />, color: 'bg-orange-500', trend: '-2.4%' },
  ];
